...
<form name="f" action="write.notice" method="post" enctype="multipart/form-data">   
   <table id="customers">
      <tr>
         <th width="20%">이 름</th>
         <td>
      ...
      <input type="button" class="button button1" value="글목록" onclick="location.href='list.notice'">
</form>
</div>
</body>
</html>
