...
<form name="f" action="write.board" method="post" enctype="multipart/form-data">   
   <table id="customers">
      <tr>
         <th width="20%">이 름</th>
         <td>관리자</td>
      ...
      <input type="button" class="button button1" value="글목록" onclick="location.href='list.board'">
</form>
</div>
</body>
</html>
